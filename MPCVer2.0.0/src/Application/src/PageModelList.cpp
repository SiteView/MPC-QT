...
void PageModelList::initCenter()//加载数据
{
...
void PageModelList::initBottom()//初始化底部界面
{
...
void PageModelList::showPage(QString current_skin)//页码的切换
{
    qDebug()<<current_skin<<"-----------";
...
void PageModelList::paintEvent(QPaintEvent *)
{
...
void PageModelList::mousePressEvent( QMouseEvent * event )
{
    //只能是鼠标左键移动和改变大小
...
void PageModelList::mouseReleaseEvent(QMouseEvent *)
{
    mouse_press = false;
}
