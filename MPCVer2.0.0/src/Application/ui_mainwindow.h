...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        widget_4->setGeometry(QRect(168, 0, 360, 50));
        ...
        lab_dm = new QLabel(widget_bottom);
        lab_dm->setObjectName(QStringLiteral("lab_dm"));
        lab_dm->setGeometry(QRect(820, 10, 12, 12));
        but_dm = new QPushButton(widget_bottom);
        but_dm->setObjectName(QStringLiteral("but_dm"));
        but_dm->setGeometry(QRect(830, 5, 85, 20));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        lineEdit_s_4->setText(QApplication::translate("MainWindow", "360", 0));
        ...
        lab_dm->setText(QString());
        but_dm->setText(QString());
    } // retranslateUi
