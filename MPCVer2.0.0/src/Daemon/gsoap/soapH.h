...
#define soap_write_MPC__typeRequest(soap, data) ( soap_serialize_MPC__typeRequest(soap, data), soap_begin_send(soap) || soap_put_MPC__typeRequest(soap, data, "MPC:typeRequest", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write_MPC__flashReguest(soap, data) ( soap_serialize_MPC__flashReguest(soap, data), soap_begin_send(soap) || soap_put_MPC__flashReguest(soap, data, "MPC:flashReguest", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write_MPC__flashReguestResponse(soap, data) ( soap_serialize_MPC__flashReguestResponse(soap, data), soap_begin_send(soap) || soap_put_MPC__flashReguestResponse(soap, data, "MPC:flashReguestResponse", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write_MPC__npRequest(soap, data) ( soap_serialize_MPC__npRequest(soap, data), soap_begin_send(soap) || soap_put_MPC__npRequest(soap, data, "MPC:npRequest", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write_MPC__npRequestResponse(soap, data) ( soap_serialize_MPC__npRequestResponse(soap, data), soap_begin_send(soap) || soap_put_MPC__npRequestResponse(soap, data, "MPC:npRequestResponse", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write__MPC__npRequestResponse(soap, data) ( soap_serialize__MPC__npRequestResponse(soap, data), soap_begin_send(soap) || soap_put__MPC__npRequestResponse(soap, data, "MPC:npRequestResponse", NULL) || soap_end_send(soap), soap->error )
#endif
...
inline struct _MPC__npRequestResponse * soap_new_req__MPC__npRequestResponse(struct soap *soap, std::string& AppID, std::string& AppName, std::string& DisplayName, std::string& Detailtext, std::string& Mark, std::string& Type, std::string& ServerVersion, std::string& ResetServerVersion, std::string& Size, std::string& OrderNumber, std::string& AllDownload, std::string& FewDownload, std::string& DownloadURL, std::string& OS) { struct _MPC__npRequestResponse *_p = soap_instantiate__MPC__npRequestResponse(soap, -1, NULL, NULL, NULL); if (_p) { soap_default__MPC__npRequestResponse(soap, _p); _p->AppID = AppID; _p->AppName = AppName; _p->DisplayName = DisplayName; _p->Detailtext = Detailtext; _p->Mark = Mark; _p->Type = Type; _p->ServerVersion = ServerVersion; _p->ResetServerVersion = ResetServerVersion; _p->Size = Size; _p->OrderNumber = OrderNumber; _p->AllDownload = AllDownload; _p->FewDownload = FewDownload; _p->DownloadURL = DownloadURL; _p->OS = OS; } return _p; }

inline struct _MPC__npRequestResponse * soap_new_set__MPC__npRequestResponse(struct soap *soap, std::string& AppID, std::string& AppName, std::string& DisplayName, std::string& Detailtext, std::string& Mark, std::string& Type, std::string& ServerVersion, std::string& ResetServerVersion, std::string& Size, std::string& OrderNumber, std::string& AllDownload, std::string& FewDownload, std::string& DownloadURL, std::string& OS) { struct _MPC__npRequestResponse *_p = soap_instantiate__MPC__npRequestResponse(soap, -1, NULL, NULL, NULL); if (_p) { soap_default__MPC__npRequestResponse(soap, _p); _p->AppID = AppID; _p->AppName = AppName; _p->DisplayName = DisplayName; _p->Detailtext = Detailtext; _p->Mark = Mark; _p->Type = Type; _p->ServerVersion = ServerVersion; _p->ResetServerVersion = ResetServerVersion; _p->Size = Size; _p->OrderNumber = OrderNumber; _p->AllDownload = AllDownload; _p->FewDownload = FewDownload; _p->DownloadURL = DownloadURL; _p->OS = OS; } return _p; }
...
#define soap_write_MPC__npRequestRequest(soap, data) ( soap_serialize_MPC__npRequestRequest(soap, data), soap_begin_send(soap) || soap_put_MPC__npRequestRequest(soap, data, "MPC:npRequestRequest", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write__MPC__npRequestRequest(soap, data) ( soap_serialize__MPC__npRequestRequest(soap, data), soap_begin_send(soap) || soap_put__MPC__npRequestRequest(soap, data, "MPC:npRequestRequest", NULL) || soap_end_send(soap), soap->error )
#endif
...
inline struct _MPC__npRequestRequest * soap_new_req__MPC__npRequestRequest(struct soap *soap, std::string& AppID, std::string& DisplayName, std::string& ResetServerVersion, std::string& URLInfoAbout, std::string& Publisher) { struct _MPC__npRequestRequest *_p = soap_instantiate__MPC__npRequestRequest(soap, -1, NULL, NULL, NULL); if (_p) { soap_default__MPC__npRequestRequest(soap, _p); _p->AppID = AppID; _p->DisplayName = DisplayName; _p->ResetServerVersion = ResetServerVersion; _p->URLInfoAbout = URLInfoAbout; _p->Publisher = Publisher; } return _p; }

inline struct _MPC__npRequestRequest * soap_new_set__MPC__npRequestRequest(struct soap *soap, std::string& AppID, std::string& DisplayName, std::string& ResetServerVersion, std::string& URLInfoAbout, std::string& Publisher) { struct _MPC__npRequestRequest *_p = soap_instantiate__MPC__npRequestRequest(soap, -1, NULL, NULL, NULL); if (_p) { soap_default__MPC__npRequestRequest(soap, _p); _p->AppID = AppID; _p->DisplayName = DisplayName; _p->ResetServerVersion = ResetServerVersion; _p->URLInfoAbout = URLInfoAbout; _p->Publisher = Publisher; } return _p; }
...
#define soap_write_PMPC__npRequestResponse(soap, data) ( soap_serialize_PMPC__npRequestResponse(soap, data), soap_begin_send(soap) || soap_put_PMPC__npRequestResponse(soap, data, "MPC:npRequestResponse", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write_PointerTo_MPC__npRequestResponse(soap, data) ( soap_serialize_PointerTo_MPC__npRequestResponse(soap, data), soap_begin_send(soap) || soap_put_PointerTo_MPC__npRequestResponse(soap, data, "MPC:npRequestResponse", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write_PMPC__npRequestRequest(soap, data) ( soap_serialize_PMPC__npRequestRequest(soap, data), soap_begin_send(soap) || soap_put_PMPC__npRequestRequest(soap, data, "MPC:npRequestRequest", NULL) || soap_end_send(soap), soap->error )
#endif
...
#define soap_write_PointerTo_MPC__npRequestRequest(soap, data) ( soap_serialize_PointerTo_MPC__npRequestRequest(soap, data), soap_begin_send(soap) || soap_put_PointerTo_MPC__npRequestRequest(soap, data, "MPC:npRequestRequest", NULL) || soap_end_send(soap), soap->error )
#endif
